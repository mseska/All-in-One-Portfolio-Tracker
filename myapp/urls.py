...
urlpatterns = [
    ...
    path('api/increase-in-portfolio', views.modify_portfolio, name='modify_portfolio'),
    path('api/decrease-in-portfolio', views.modify_portfolio, name='modify_portfolio'),
