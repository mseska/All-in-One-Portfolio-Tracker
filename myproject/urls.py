...
urlpatterns = [
    ...
    path('api/get-monthly-data-portfolio', get_monthly_data_portfolio, name='get_monthly_data_portfolio'),
    path('api/get-monthly-data-asset', get_monthly_data_asset, name='get_monthly_data_asset'),
    path('api/get-yearly-data-portfolio', get_yearly_data_portfolio, name='get_yearly_data_portfolio'),
    path('api/get-yearly-data-asset', get_yearly_data_asset, name='get_yearly_data_asset'),
]
